  ...
  <body >
    <div class="container">
      <h1 style="text-align: center;"> Insertion de Date:</h1>
          ...
          <form class="needs-validation" action="Ok4.jsp">
              <div class="row g-3">
                ...
                <div class="col-4">
                  <label for="username" class="form-label">Date_2</label>
                  <div class="input-group has-validation">
                    <input type="date" name="dates2" class="form-control" id="username" placeholder="Username" required>
                  </div>
                </div>
          ...
          <%
          String da = request.getParameter("dates1");
          String da2 = request.getParameter("dates2");
          %>
